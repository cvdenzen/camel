 ...
 */
@UriParams
public class PilightConfiguration implements Cloneable {
     ...
     */
    public PilightConfiguration copy() {
        try {
            return (PilightConfiguration) clone();
    ...
    /**
     * To set the textline protocol encoder max line length. By default the default value of Pilight itself is used which are Integer.MAX_VALUE.
     */
    ...
    /**
     * To set the textline protocol decoder max line length. By default the default value of Pilight itself is used which are 1024.
     */
    ...
    public boolean isPilightLogger() {
        return minaLogger;
    }
     ...
     */
    public void setPilightLogger(boolean minaLogger) {
    ...
    /**
     * You can set a list of Pilight IoFilters to use.
     */
    ...
    /**
     * Whether or not to disconnect(close) from Pilight session right after use. Can be used for both consumer and producer.
     */
    ...
    /**
     * If sync is enabled then this option dictates PilightConsumer if it should disconnect where there is no reply to send back.
     */
    ...
    /**
     * If sync is enabled this option dictates PilightConsumer which logging level to use when logging a there is no reply to send back.
     */
