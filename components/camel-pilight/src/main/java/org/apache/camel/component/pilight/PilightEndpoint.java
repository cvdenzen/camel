 ...
 */
@UriEndpoint(firstVersion = "2.14.0", scheme = "pilight", title = "Pilight", syntax = "pilight:protocol:host:port", consumerClass = NettyConsumer.class, label = "networking,tcp,udp")
public class NettyEndpoint extends DefaultEndpoint implements AsyncEndpoint {
    @UriParam
    private NettyConfiguration configuration;
    @UriParam(label = "advanced", javaType = "org.apache.camel.component.pilight.NettyServerBootstrapConfiguration",
    ...
    protected String createEndpointUri() {
        ...
        return "pilight:" + getConfiguration().getProtocol() + "://" + getConfiguration().getHost() + ":" + getConfiguration().getPort();
    }
