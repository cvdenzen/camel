    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("direct:start")
                    .to("pilight:tcp://localhost:{{port}}?textline=true&sync=true&sharedChannel=channel1&disconnect=true")
                ...
                from("pilight:tcp://localhost:{{port}}?textline=true&sync=true&sharedChannel=channel1")
