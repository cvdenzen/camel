...
public class NettyTransferExchangeOptionTest extends BaseNettyTest {
    ...
    private Exchange sendExchange(boolean setException) throws Exception {
        Endpoint endpoint = context.getEndpoint("pilight:tcp://localhost:{{port}}?transferExchange=true");
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                from("pilight:tcp://localhost:{{port}}?transferExchange=true").process(new Processor() {
