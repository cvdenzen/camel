...
/**
 * Unit testing for using a PilightProducer that it can shutdown properly (CAMEL-395)
 * <p>
 * Run this test from maven: mvn exec:java and see the output if there is a error.
 */
@Ignore
public class PilightProducerShutdownTest extends TestSupport {
    ...
    public static void main(String[] args) throws Exception {
        PilightProducerShutdownTest me = new PilightProducerShutdownTest();
        me.testProducer();
    }
    ...
    private class AssertShutdownHook extends Thread {
        public void run() {
            ...
            if (diff > 5000) {
                log.error("ERROR: PilightProducer should be able to shutdown within 5000 millis: time=" + diff);
            }
        }
    }
