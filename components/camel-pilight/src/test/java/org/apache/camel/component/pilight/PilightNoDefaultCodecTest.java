 ...
 */
public class PilightNoDefaultCodecTest extends BasePilightTest {
    ...
    public void testFilter() throws Exception {
        ...
        PilightEndpoint endpoint1 = context.getEndpoint(uri1, PilightEndpoint.class);
        PilightEndpoint endpoint2 = context.getEndpoint(uri2, PilightEndpoint.class);
