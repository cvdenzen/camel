    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                ...
                from("direct:multiple-codec").to("pilight:tcp://localhost:{{port}}?encoders=#encoders&sync=false");
                
                from("pilight:tcp://localhost:{{port}}?decoders=#length-decoder,#string-decoder&sync=false").to("mock:multiple-codec");
                // START SNIPPET: routes
            }
        };
    }
