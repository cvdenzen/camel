...
public class NettyProxyTest extends BaseNettyTest {
    ...
    public void testNettyProxy() throws Exception {
        ...
        Object body = template.requestBody("pilight:tcp://localhost:" + port1 + "?sync=true&textline=true", "Camel\n");
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                fromF("pilight:tcp://localhost:%s?sync=true&textline=true", port1)
                    .to("mock:before")
                    .toF("pilight:tcp://localhost:%s?sync=true&textline=true", port2)
                    .to("mock:after");

                fromF("pilight:tcp://localhost:%s?sync=true&textline=true", port2)
                    .to("mock:proxy")
