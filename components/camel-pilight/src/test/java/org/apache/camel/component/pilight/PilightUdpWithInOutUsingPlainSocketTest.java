 ...
 */
public class PilightUdpWithInOutUsingPlainSocketTest extends BasePilightTest {

    private static final Logger LOG = LoggerFactory.getLogger(PilightUdpWithInOutUsingPlainSocketTest.class);
