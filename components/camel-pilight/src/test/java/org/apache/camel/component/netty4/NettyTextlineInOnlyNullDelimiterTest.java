...
public class NettyTextlineInOnlyNullDelimiterTest extends BaseNettyTest {
    ...
    public void testTextlineInOnlyNull() throws Exception {
        ...
        template.sendBody("pilight:tcp://localhost:{{port}}?textline=true&delimiter=NULL&sync=false", "Hello World\u0000");
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("pilight:tcp://localhost:{{port}}?textline=true&delimiter=NULL&sync=false")
