...
public class NettyInOutWithForcedNoResponseTest extends BaseNettyTest {
    ...
    public void testResponse() throws Exception {
        Object out = template.requestBody("pilight:tcp://localhost:{{port}}", "Copenhagen");
    ...
    public void testNoResponse() throws Exception {
        try {
            template.requestBody("pilight:tcp://localhost:{{port}}", "London");
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                from("pilight:tcp://localhost:{{port}}")
                    .choice()
