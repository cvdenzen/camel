 ...
 * @version 
 */
public class PilightExchangeDefaultTimeOutTest extends BasePilightTest {
            ...
            public void configure() {
                from("mina:tcp://localhost:{{port}}?textline=true&sync=true").process(new Processor() {
                    public void process(Exchange e) throws Exception {
                        ...
                        // PilightProducer has a default timeout of 30 seconds so we just wait 5 seconds
                        // (template.requestBody is a PilightProducer behind the doors)
                        Thread.sleep(5000);
