 ...
 * @version 
 */
public class PilightVMTransferExchangeOptionTest extends BasePilightTest {

    @Test
    public void testPilightTransferExchangeOptionWithoutException() throws Exception {
        Exchange exchange = sendExchange(false);
        assertExchange(exchange, false);
    }

    @Test
    public void testPilightTransferExchangeOptionWithException() throws Exception {
