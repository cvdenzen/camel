 ...
 * @version 
 */
public class PilightTcpWithInOutTest extends BasePilightTest {
    ...
    @Test
    public void testPilightRouteWithInOut() throws Exception {
    ...
    @Test
    public void testPilightRouteWithInOutLazy() throws Exception {
        latch = new CountDownLatch(1);
