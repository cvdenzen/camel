 ...
 */
public class PilightInOutCloseSessionWhenCompleteTest extends BasePilightTest {
            ...
            public void configure() throws Exception {
                from("mina:tcp://localhost:{{port}}?sync=true&textline=true").process(new Processor() {
                    public void process(Exchange exchange) throws Exception {
                        ...
                        exchange.getOut().setHeader(PilightConstants.MINA_CLOSE_SESSION_WHEN_COMPLETE, true);
                    }
                });
            }
        };
