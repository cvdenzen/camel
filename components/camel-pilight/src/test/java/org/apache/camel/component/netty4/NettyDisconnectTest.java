...
public class NettyDisconnectTest extends BaseNettyTest {
    ...
    public void testCloseSessionWhenComplete() throws Exception {
        Object out = template.requestBody("pilight:tcp://localhost:{{port}}?sync=true&disconnect=true", "Claus");
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                from("pilight:tcp://localhost:{{port}}?sync=true&disconnect=true").process(new Processor() {
