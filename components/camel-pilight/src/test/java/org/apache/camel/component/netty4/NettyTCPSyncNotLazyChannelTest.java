...
public class NettyTCPSyncNotLazyChannelTest extends BaseNettyTest {
    ...
    public void testTCPStringInOutWithNettyConsumer() throws Exception {
        String response = template.requestBody(
            "pilight:tcp://localhost:{{port}}?sync=true&lazyChannelCreation=false",
    ...
    public void testTCPObjectInOutWithNettyConsumer() throws Exception {
        ...
        Poetry response = (Poetry) template.requestBody("pilight:tcp://localhost:{{port}}?sync=true&lazyChannelCreation=false", poetry);
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("pilight:tcp://localhost:{{port}}?sync=true")
