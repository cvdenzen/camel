    ...
    public void testSSLInOutWithNettyConsumer() throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            public void configure() {
                ...
                from("pilight:tcp://localhost:{{port}}?sync=true&ssl=true&passphrase=changeit&keyStoreFile=#ksf&trustStoreFile=#tsf&needClientAuth=true")
        ...
        String response = template.requestBody(
                "pilight:tcp://localhost:{{port}}?sync=true&ssl=true&passphrase=changeit&keyStoreFile=#ksf&trustStoreFile=#tsf",
