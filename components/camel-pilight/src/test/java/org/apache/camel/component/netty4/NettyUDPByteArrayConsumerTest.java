...
public class NettyUDPByteArrayConsumerTest extends BaseNettyTest {
    ...
    public void testUDPInOnlyWithNettyConsumer() throws Exception {
        ...
        template.sendBody("pilight:udp://localhost:{{port}}?sync=false&udpByteArrayCodec=true", "***Camel rocks ?=)".getBytes());
    ...
    public void testSendingRawByteMessage() throws Exception {
        ...
        template.sendBody("pilight:udp://localhost:{{port}}?sync=false&udpByteArrayCodec=true", in);
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("pilight:udp://localhost:{{port}}?sync=false&udpByteArrayCodec=true")
                        .to("mock:result");
            }
        };
    }
