...
/**
 * Unit test to check if the message of an exchange send from the PilightConsumer
 * is a PilightMessage.
 */
public class MessageIOSessionTest extends BasePilightTest {
    ...
    public void testIoSession() throws Exception {
        ...
        assertNotNull(message.getHeader(PilightConstants.MINA_IOSESSION));
    ...
    public void testLocalAndRemoteAddressHeaders() throws Exception {
        ...
        assertNotNull(message.getHeader(PilightConstants.MINA_LOCAL_ADDRESS, SocketAddress.class));
        assertNotNull(message.getHeader(PilightConstants.MINA_REMOTE_ADDRESS, SocketAddress.class));
    }
