...
public class NettyGlobalSSLContextParametersTest extends BaseNettyTest {
    ...
    protected CamelContext createCamelContext() throws Exception {
        ...
        ((SSLContextParametersAware) context.getComponent("pilight")).setUseGlobalSslContextParameters(true);
        return context;
    }
    ...
    public void testSSLInOutWithNettyConsumer() throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            public void configure() {
                from("pilight:tcp://localhost:{{port}}?sync=true&ssl=true")
        ...
        String response = template.requestBody(
                "pilight:tcp://localhost:{{port}}?sync=true&ssl=true",
