...
public class NettyComponentWithConfigurationTest extends CamelTestSupport {
    ...
    public void testNettyComponentWithConfiguration() throws Exception {
        NettyComponent comp = context.getComponent("pilight", NettyComponent.class);
        ...
        NettyEndpoint e1 = (NettyEndpoint) comp.createEndpoint("pilight://tcp://localhost:4455");
        NettyEndpoint e2 = (NettyEndpoint) comp.createEndpoint("pilight://tcp://localhost:5566?sync=false&needClientAuth=true");
    ...
    public void testNettyComponentUdpWithConfiguration() throws Exception {
        ...
        NettyEndpoint e1 = (NettyEndpoint) comp.createEndpoint("pilight://udp://localhost:8601?sync=false");
        NettyEndpoint e2 = (NettyEndpoint) comp.createEndpoint("pilight://udp://localhost:8602?sync=false&udpConnectionlessSending=true");
