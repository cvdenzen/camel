...
import org.apache.camel.component.pilight.handlers.ClientChannelHandler;
import org.apache.camel.component.pilight.handlers.ServerChannelHandler;
...
public class NettyCustomPipelineFactorySynchTest extends BaseNettyTest {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("pilight:tcp://localhost:{{port}}?serverInitializerFactory=#spf&sync=true&textline=true")
    ...
    public void testCustomClientPipelineFactory() throws Exception {
        String response = (String) template.requestBody(
                "pilight:tcp://localhost:{{port}}?clientInitializerFactory=#cpf&sync=true&textline=true",
