 ...
 * @version 
 */
public class PilightTcpLineDelimiterUsingPlainSocketTest extends BasePilightTest {

    @Test
    public void testSendAndReceiveOnce() throws Exception {
        String response = sendAndReceive("World");

        assertNotNull("Nothing received from Pilight", response);
    ...
    public void testSendAndReceiveTwice() throws Exception {
        ...
        assertNotNull("Nothing received from Pilight", london);
        assertNotNull("Nothing received from Pilight", paris);
    ...
    private String sendAndReceive(String input) throws IOException {
        ...
        try {
            ...
            // must append MAC newline at the end to flag end of textline to Camel-Pilight
