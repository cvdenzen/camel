 ...
 * @version 
 */
public class PilightConverterTest extends TestCase {

    public void testToByteArray() {
        byte[] in = "Hello World".getBytes();
        ByteBuffer bb = ByteBuffer.wrap(in);

        byte[] out = PilightConverter.toByteArray(bb);
    ...
    public void testToString() throws UnsupportedEncodingException {
        ...
        String out = PilightConverter.toString(bb, exchange);
    ...
    public void testToStringTwoTimes() throws UnsupportedEncodingException {
        ...
        out = PilightConverter.toString(bb, exchange);
        assertEquals("Hello World \u4f60\u597d", out);
    }
    ...
    public void testToInputStream() throws Exception {
        ...
        InputStream is = PilightConverter.toInputStream(bb);
        for (byte b : in) {
            int out = is.read();
            assertEquals(b, out);
        }
    ...
    public void testToByteBuffer() {
        ...
        ByteBuffer bb = PilightConverter.toByteBuffer(in);
        assertNotNull(bb);
