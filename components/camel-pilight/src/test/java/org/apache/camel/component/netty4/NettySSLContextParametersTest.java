    ...
    public void testSSLInOutWithNettyConsumer() throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            public void configure() {
                from("pilight:tcp://localhost:{{port}}?sync=true&ssl=true&sslContextParameters=#sslContextParameters")
        ...
        String response = template.requestBody(
                "pilight:tcp://localhost:{{port}}?sync=true&ssl=true&sslContextParameters=#sslContextParameters",
